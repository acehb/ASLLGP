...
`PiezoTrueEQLonGridPoints.m`: Script used to compute the true EQL at all $`\mathbf{x}_c\in{\{0,0.005,…,1}\}^2`$ for Example 2 (used to compute the data stored in `Piezo True EQL on grid points.mat` file).
