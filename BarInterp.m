function [ys,ym]=BarInterp(stress,mass,x,fidelity)
%Inputs stress: the maximum Von Mises stress outputs of the HF and LF simulators on the 11^2 grid {0,0.1,бн,1}^2; mass:the mass of the small bar output of both simulators on the 11^2 grid {0,0.1,бн,1}^2;x:input setting at which interpolated outputs is desired;
...
%Outputs ys:the interpolated maximum von mises stress;ym: the interpolated mass of the small bar.
