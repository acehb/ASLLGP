...
%Outputs EQL_AGPL:posterior mean of EQL given by the AGPL/GPL model;lb_AGPL:95% Lower credible limit of EQL given by the AGPL/GPL model;ub_AGPL:95% Upper credible limit of EQL given by the AGPL/GPL model
