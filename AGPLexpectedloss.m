...
%Outputs EQL_AGPL:posterior mean of EQL given by the AGPL(nargin==16)/the GP for loss (nargin==9) model;lb_AGPL:95% Lower credible limit of EQL given by the AGPL(nargin==16)/the GP for loss (nargin==9) model;ub_AGPL:95% Upper credible limit of EQL given by the AGPL(nargin==16)/the GP for loss (nargin==9) model
