...
%[thetal,betal,tao2l,irResl,irxl]=the outputs of gpfitASLL1level.m;x:the design used in the high-fidelity experiment;[transpar,theta,rou,beta,tao2,irRes,irx]=the outputs of gpfitASLL2level.m;
%Outputs EQL_ASLL:posterior mean of EQL given by the ASLLGP model;lb_ASLL:95% Lower credible limit of EQL given by the ASLLGP model;ub_ASLL:95% Upper credible limit of EQL given by the ASLLGP model
Nx_e=size(x_e,1);
