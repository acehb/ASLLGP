...
%Outputs EQL_ASLL:posterior mean of EQL given by the ASLLGP(nargin==17)/the shifted log loss GP(nargin==10) model;lb_ASLL:95% Lower credible limit of EQL given by the ASLLGP(nargin==17)/the shifted log loss GP(nargin==10) model;ub_ASLL:95% Upper credible limit of EQL given by the ASLLGP(nargin==17)/the shifted log loss GP(nargin==10) model
Nx_e=size(x_e,1);
