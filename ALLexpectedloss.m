...
%Outputs EQL_ALL:posterior mean of EQL given by the ALL model;lb_ALL:95% Lower credible limit of EQL given by the ALL model;ub_ALL:95% Upper credible limit of EQL given by the ALL model
Nx_e=size(x_e,1);
