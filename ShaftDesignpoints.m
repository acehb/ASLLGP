% gives the 100 maximin nested Latin hypercube designs 
clear
...
[yhs_all(:,k),~]=ShaftInterp(stress,mass,xtemp,2);
[yls_all(:,k),ym_all(:,k)]=ShaftInterp(stress,mass,xltemp,1);
end
%% give 100 maximin Latin hypercube designs for 3 single-fidelity models.
...
[ys_allonefi(:,k),ym_allonefi(:,k)]=ShaftInterp(stress,mass,xtemponefi,2);

end
save('Designs for the shaft example.mat');
