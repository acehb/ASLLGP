...
%Inputs L:beam length;H:beam height;d31:piezoelectric d_31 strain coefficient;V:voltage;fidelity==1:low-fidelity simulation,fidelity==2:high-fidelity simulation.
...
resultH = solvepde(model);
rsH = resultH.NodalSolution;
yd= min(rsH(:,2));
ym= H*L;
