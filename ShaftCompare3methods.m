...
load('200 test points for the shaft example.mat');
...
for k=1:ndesign
    ...
    %get the summaries of the five EQL prediction performance measures for the ASLLGP, ALL, and AGPL models as given in Table 2. 
...
toc
%% get the summaries of the five EQL prediction performance measures for the SLLGP, LL, and GPL models
tic
