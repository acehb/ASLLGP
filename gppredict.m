...
%Outputs mu: posterior mean of the high-fidelity response for the autoregressive GP model;var:posterior covariance of the high-fidelity response for the autoregressive GP model;
%mul:posterior mean of the low-fidelity response for the autoregressive GP model;varl:posterior covariance of the low-fidelity response for the autoregressive GP model.
ntest=size(x_test,1);
