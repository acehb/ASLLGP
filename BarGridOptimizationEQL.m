...
for i=1:n
    [Ll(i),Ll_s(i)]=lossBar(yls(i),ym(i));
end
for i=1:m
    [Lh(i),Lh_s(i)]=lossBar(yhs(i),ym(i));
end
%fit 3 models
...
minALLEQL=BarTrueEQL(xcminALL,stress,mass,w,x_e);
minASLLEQL=BarTrueEQL(xcminASLL,stress,mass,w,x_e);
minAGPLEQL=BarTrueEQL(xcminAGPL,stress,mass,w,x_e);
